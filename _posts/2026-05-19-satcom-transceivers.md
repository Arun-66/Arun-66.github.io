...
<figure>
  <svg viewBox="0 0 720 200" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:720px;font-family:monospace;font-size:12px;">
    <!-- RX chain -->
    <rect x="10" y="30" width="80" height="40" rx="4" fill="none" stroke="#2C5F5D" stroke-width="1.5"/>
    <text x="50" y="55" text-anchor="middle" fill="currentColor">ANT</text>
    <line x1="90" y1="50" x2="120" y2="50" stroke="#2C5F5D" stroke-width="1.5"/>
    <rect x="120" y="30" width="80" height="40" rx="4" fill="none" stroke="#2C5F5D" stroke-width="1.5"/>
    <text x="160" y="55" text-anchor="middle" fill="currentColor">LNA</text>
    <line x1="200" y1="50" x2="230" y2="50" stroke="#2C5F5D" stroke-width="1.5"/>
    <rect x="230" y="30" width="80" height="40" rx="4" fill="none" stroke="#2C5F5D" stroke-width="1.5"/>
    <text x="270" y="55" text-anchor="middle" fill="currentColor">MIXER</text>
    <line x1="310" y1="50" x2="340" y2="50" stroke="#2C5F5D" stroke-width="1.5"/>
    <rect x="340" y="30" width="80" height="40" rx="4" fill="none" stroke="#2C5F5D" stroke-width="1.5"/>
    <text x="380" y="55" text-anchor="middle" fill="currentColor">VGA</text>
    <line x1="420" y1="50" x2="450" y2="50" stroke="#2C5F5D" stroke-width="1.5"/>
    <rect x="450" y="30" width="80" height="40" rx="4" fill="none" stroke="#2C5F5D" stroke-width="1.5"/>
    <text x="490" y="55" text-anchor="middle" fill="currentColor">ADC</text>
    <line x1="530" y1="50" x2="560" y2="50" stroke="#2C5F5D" stroke-width="1.5"/>
    <rect x="560" y="30" width="100" height="40" rx="4" fill="none" stroke="#2C5F5D" stroke-width="1.5"/>
    <text x="610" y="55" text-anchor="middle" fill="currentColor">BASEBAND</text>
    <!-- LO -->
    <rect x="230" y="120" width="80" height="40" rx="4" fill="none" stroke="#1F4068" stroke-width="1.5" stroke-dasharray="4,2"/>
    <text x="270" y="145" text-anchor="middle" fill="currentColor">LO / PLL</text>
    <line x1="270" y1="120" x2="270" y2="70" stroke="#1F4068" stroke-width="1.5" stroke-dasharray="4,2"/>
    <!-- Labels -->
    <text x="360" y="195" text-anchor="middle" fill="#888" font-size="11">Ka-band receive chain — LO/PLL shown as the critical shared block</text>
  </svg>
</figure>
...
<figure>
  <svg viewBox="0 0 720 180" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:720px;font-family:monospace;font-size:11px;">
    <!-- Earth -->
    <circle cx="360" cy="160" r="50" fill="none" stroke="#2C5F5D" stroke-width="2"/>
    <text x="360" y="164" text-anchor="middle" fill="currentColor" font-size="12">EARTH</text>
    <!-- GEO arc -->
    <path d="M 100 60 Q 360 -30 620 60" fill="none" stroke="#1F4068" stroke-width="1.5" stroke-dasharray="6,3"/>
    <text x="360" y="18" text-anchor="middle" fill="#1F4068">GEO ~35,786 km — stationary</text>
    <!-- LEO arc -->
    <path d="M 180 95 Q 360 40 540 95" fill="none" stroke="#2C5F5D" stroke-width="1.5"/>
    <text x="360" y="58" text-anchor="middle" fill="#2C5F5D">LEO ~550 km — moving at 7.5 km/s</text>
    <!-- Ground terminal -->
    <rect x="330" y="108" width="60" height="20" rx="3" fill="none" stroke="#888" stroke-width="1"/>
    <text x="360" y="122" text-anchor="middle" fill="#888">Terminal</text>
    <text x="360" y="175" text-anchor="middle" fill="#888" font-size="10">GEO: fixed beam pointing. LEO: continuous electronic steering required.</text>
  </svg>
</figure>
